...
function isIzogram(izogram){
    let wynik = true;
    izogram = izogram.toUpperCase();
    for(let i =0; i < izogram.length; i++){
        for(let j = i +1; j < izogram.length; j++){
        if(izogram[i] == izogram[j]){
            wynik = false;
        }
    }
    }
...
//   a następnie zwróci ten ciąg ze słowami w odwróconej kolejności.
    ...
    //oblicza sin cos i tg i ctg
    // function tryg(przeciwprostokątna, przypatrzy,przyniepatrzy,funkcja){
    //     let wynik = 0;
    //     if(przypatrzy + przyniepatrzy > przeciwprostokątna){
    //         switch(funkcja){
    //             case "sin":
    //                 wynik = przypatrzy / przeciwprostokątna;
    //                 break;
    //             case "cos":
    //                 wynik = przyniepatrzy / przeciwprostokątna;
    //                 break;
    //             case "tg":
    //                 wynik = przypatrzy /przyniepatrzy;
    //                 break;
    //             case "ctg":
    //                 wynik = przyniepatrzy /przypatrzy;
    //                 break;
    //     }
    //     }
    //     else{
    //         wynik = ("taki trójkąt nie istnieje");
    //     }
    //     return wynik;
    ...
    //      switch(funkcja){
    //         case "sin":
    //             wynik = Math.asin(wynik) * 180 / Math.PI;
    //             break;
    //         case "cos":
    //             wynik = Math.acos(wynik) * 180 / Math.PI;
    //             break;
    //         case "tg":
    //             wynik = Math.atan(wynik) * 180 / Math.PI;
    //             break;
    //         case "ctg":
    //             wynik = Math.atan(1 / wynik) * 180 / Math.PI;
    //             break;
    //      }
    //     return wynik;
    ...
    function tryg(przeciwprostokątna, przypatrzy, przyniepatrzy, funkcja) {
        let wynik = 0;
        if (przypatrzy + przyniepatrzy > przeciwprostokątna &&
            przypatrzy + przeciwprostokątna > przyniepatrzy &&
            przyniepatrzy + przeciwprostokątna > przypatrzy) {
            ...
            switch (funkcja) {
                ...
                case "ctg":
                    if (wynik !== 0) {
                        ...
                        return "Ctg nie jest zdefiniowane dla 0";
                    }
                    break;
            }
        } else {
            return "Taki trójkąt nie istnieje";
        }
